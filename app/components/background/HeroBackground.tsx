...
const HeroBackground: React.FC = () => {
    return (
        <div className="pointer-events-none absolute -inset-y-16 inset-x-0 z-0">
            <video className="h-full w-full scale-105 object-cover opacity-10 saturate-50" autoPlay={true} playsInline={true} loop muted preload="auto">
